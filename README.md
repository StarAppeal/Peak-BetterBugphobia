...
5. Edit the **BetterBugphobia** config  in `...\PEAK\BepInEx\config` to your liking
...
### Should any issues occur you can reach out to *@starappeal* on Discord.
